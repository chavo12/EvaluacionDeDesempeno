...
{
    class EditableRows : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value is LBSFramework.Entitys.Entity)
            {
                ...
                if (row != null)
                {
                    if (row.Editable)
                    {
                        Uri uri = new Uri("pack://siteoforigin:,,,/Resources/EditarEnable16.png");
                    ...
                    if (!row.Editable)
                    {
                        ...
                        Uri uri = new Uri("pack://siteoforigin:,,,/Resources/EditarDisable16.png");
                        BitmapImage source = new BitmapImage(uri);
                        return source;
                    }
                }
