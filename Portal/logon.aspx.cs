   ...
   protected void Login_Click(object sender, EventArgs e)
    {
        ...
        if (emp != null)
        {
            if (!string.IsNullOrEmpty(emp.clave) && emp.clave == txtPassword.Text)
            {
            ...
            if (ingresoCorrecto)
            {
                ...
                //FormsAuthentication.RedirectFromLoginPage(emp.EmpleadoId, true);
            }
            else
            {
                errorLabel.Text = "Usuario o contraseña incorrecto";
            }
